		...
		<div id="blog-section">
				<div class="container">
					<div class="theme-title">
						<h2>Details</h2>
						<p style="text-align:justify">NSTU-Bicycle Rental service is open for all NSTUian.Our Bicycle station is within Noakhali Science and Technology University campus
.This service only  available for university's interreated persons like as student,teacher or staff.The bicycle locked into the stands,
when a bicycle is hired it is released by the system.
On return, the bicycle is locked back into a stand at station, and the hire is then completed.In the event of the disappearance of a cycleplease immediately notify us of
 its disappearance.If there is something wrong with the bike Please let us know</p>
 </div> <!-- /.theme-title -->
							...
							<div class="left-side">
								...
								<ul>
									<li>
										...
										<h6>Address</h6>
										<p>3800,Noakhali Science and Technology University Campus</p>
									</li>
									<li>
